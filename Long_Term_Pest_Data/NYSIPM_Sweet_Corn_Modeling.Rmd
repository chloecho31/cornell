...
ecb_e_rf <- randomForest(Count ~ Lat.Decimal + Long.Decimal + Year + Week + Date + Day + prop_corn, data = ecb_e_features, ntree = 500, na.action = na.exclude)
importance(ecb_e_rf)
...
ecb_e_rf_1 <- randomForest(formula = Count ~ Lat.Decimal + Long.Decimal + Day + Year + Date + prop_corn,
...
ecb_z_rf_1 <- randomForest(formula = Count ~ Lat.Decimal + Long.Decimal + Day + Year + Date + prop_corn,
...
cew_rf_1 <- randomForest(formula = Count ~ Lat.Decimal + Long.Decimal + Day + Year + Date + prop_corn,
...
faw_rf_1 <- randomForest(formula = Count ~ Lat.Decimal + Long.Decimal + Day + Year + Date + prop_corn,
...
wbc_rf_1 <- randomForest(formula = Count ~ Lat.Decimals + Long.Decimal + Day + Year + Date + prop_corn,
...
y_train <- as.integer(train_set$Count)
y_test <- as.integer(test_set$Count)
