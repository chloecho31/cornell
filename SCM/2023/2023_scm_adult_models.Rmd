...
model <- glmer.nb(total_scm ~ scale(collection_date) + longitude + latitude + cover_crop + manure + ave_temp_f_1_week + rain_inches_1_week + corn_prop_5.year_500 + soybean_prop_5.year_500 + forest_prop_5.year_500 + (1 | record_id), data = adult_features)
...
model <- glmer.nb(total_scm ~  ave_temp_f_1_week + total_nat_prop_5.year_500 + ag_prop_5.year_500 + wheat_prop_5.year_1000  + hsg + (1 | record_id), data = adult_features)
summary(model)
