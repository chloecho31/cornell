...
adult_features <- adult_features %>%
  ...
  mutate_at(c('card_id', 'record_id', 'data_collector', "previous_crop", "cover_crop", "manure", "tillage", "ny_soils_0", "ny_soils_01", "muid","hsg", "hsgint"), as.factor) %>%
  dplyr::select(-c(X, card_id, n_scm_i_m, n_scm_i_f, n_scm_o_m, n_scm_o_f, n_d_florilega_i, n_d_florilega_o, total_f_scm, total_m_scm)) %>%
  dplyr::select(c(total_scm, min_temp_f_1_week, ave_temp_f_1_week, max_temp_f_1_week, vpd_min_1_week, vpd_max_1_week, rain_inches_1_week, ave_temp_f_2_week, max_temp_f_2_week, vpd_max_2_week))
...
model <- glmer.nb(total_scm ~ scale(collection_date) + cover_crop + manure + tillage + ave_temp_f_1_week + rain_inches_1_week + vpd_min_1_week + corn_prop_5.year_500 + soybean_prop_5.year_500 + total_nat_prop_5.year_500 + organic_matter_percent + (1 | record_id), data = adult_features) 
...
model <- glmer.nb(total_scm ~ scale(collection_date) + cover_crop + manure + tillage + ave_temp_f_1_week + rain_inches_1_week + vpd_min_1_week + corn_prop_5.year_500 + soybean_prop_5.year_500 + total_nat_prop_5.year_500 + organic_matter_percent + corn_prop_2022_500 + ag_prop_2.year_500 + semi_nat_prop_2022_500 + (1 | record_id), data = adult_features) 
