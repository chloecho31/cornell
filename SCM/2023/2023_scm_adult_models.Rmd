...
plot(model_effects, main='Average Weekly Temperature (°F) Effect Plot', xlab='Average Weekly Temperature (°F)', ylab=expression(paste("Number of Adult ", italic("D. platura"))), cex=5) 
