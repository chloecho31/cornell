...
paper_data %>%
  ...
  geom_bar() +
  ggtitle('Local effects, faceted by local diversification strategy') +
...
paper_data %>%
  ...
  geom_bar() +
  ggtitle('Landscape effects, faceted by local diversification strategy') +
  scale_x_discrete(guide = guide_axis(angle = 45)) +
  facet_wrap(~ local)
...
paper_data %>%
  ...
  ggplot(aes(x = local_effect)) + 
  geom_bar() +
  ggtitle('Local effects, faceted by response category') +
  scale_x_discrete(guide = guide_axis(angle = 45)) +
...
paper_data %>%
  ...
  ggplot(aes(x = landscape_effect)) + 
  geom_bar() +
  ggtitle('Landscape effects, faceted by response category') +
  scale_x_discrete(guide = guide_axis(angle = 45)) +
  facet_wrap(~ response_category)
