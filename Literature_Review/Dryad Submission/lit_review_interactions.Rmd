...
library(blme) # v.1.0.6
library(lme4) # v.1.1.36
...
SSE <- sum(residuals(model_europe)^2)
SSE

MSE <- SSE / df.residual(model_europe)
MSE
...
SSE <- sum(residuals(model_na)^2)
SSE

MSE <- SSE / df.residual(model_na)
MSE
